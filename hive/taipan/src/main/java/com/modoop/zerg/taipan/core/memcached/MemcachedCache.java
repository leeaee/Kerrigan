...
public class MemcachedCache<K, V> implements Cache<K, V>
{
     ...
     *
     * @param memcachedClient - delegate Memcached instance this Shiro cache instance will wrap.
     */
    ...
    public V get(K key) throws CacheException
    {
        try
        {
            if (key != null)
            {
                CASValue<Object> objectCASValue = memcachedClient.getAndTouch(key.toString(), expiration);
